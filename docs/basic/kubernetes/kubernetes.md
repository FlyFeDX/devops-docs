...
- [二、K8S 特性](#二k8s-特性)
- [三、K8S 组件](#三k8s-组件)
- [四、K8S 核心概念](#四k8s-核心概念)
- [五、K8S 集群部署工具](#五k8s-集群部署工具)
- [六、YAML文件解读](#六yaml文件解读)
- [七、K8S 常用命令](#七k8s-常用命令)
- [参考资料](#k8s-参考资料)
## 一、K8S 简介
...
Kubernetes 主要由以下几个核心组件组成：
 ...
 - container-runtime 负责镜像管理以及 Pod 和容器的真正运行（CRI）例如docker；
...
![K8S功能模型](../../../images/kubernetes功能全景图.png)
